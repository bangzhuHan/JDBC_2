...
//        System.out.println(10 / 0);
    ...
    public void testTransactionSelect() throws Exception {
        ...
        //获取当前连接级别
        System.out.println(connection.getTransactionIsolation());//默认为4
        //设置数据库的隔离级别
        connection.setTransactionIsolation(Connection.TRANSACTION_READ_UNCOMMITTED);//当事物的隔离级别为1时,会出现脏读的情况
        //取消自动提交数据
        connection.setAutoCommit(false);
